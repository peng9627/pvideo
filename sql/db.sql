...
INSERT INTO `account` VALUES (10000,'130@1.com','09ab3ef90da908aff3ce4cdd302f103f','ozhr4k19ts1re76nkhtpvehfxsjkd2hk',NULL,'zz0000',0,1613813625,1617021146,'127.0.0.1',0,NULL,'8888',1000000);
INSERT INTO `agent` VALUES (1,0,10000,NULL,'',10000,-1,-1,1,'');
INSERT INTO `notice` VALUES (1,1,'跑马灯','欢迎来到大米影院，最新下载地址:dm1.tv，如不能正常打开app或苹果掉签，重新下载即可!'),(2,2,'大米影院 dm1.tv','官网dm1.tv，请各位影友保存我们最新官网，以免发生app卸载后找不到网址，如果在使用过程中遇到任何问题请及时向我们反馈!');
INSERT INTO `t_account` VALUES (1,'admin','a38c74395ec7839349284e61feb64deb',1,'b76bxubllbmkrbx75nxk2hcix66wan6n',0,1616744675,'127.0.0.1',0,'');
INSERT INTO `t_role` VALUES (1,'admin','管理员',0,'',0),(2,'agent','用于登录代理系统',1591809860,'',0);
