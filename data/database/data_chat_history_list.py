...
def add_chat_history_list(connection, user_id, to_id, last_time, content):
    try:
...
def delete_chat_history_list(connection, user_id, to_id):
    try:
...
def query_chat_history_list(connection, user_id, page, pagesize=12):
    chat_history_list = []
    try:
        with connection.cursor() as cursor:
